...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_garbage_svg__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_garbage_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__assets_garbage_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_edit_svg__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_edit_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__assets_edit_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_link_symbol_svg__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_link_symbol_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__assets_link_symbol_svg__);
    ...
    function Toolbar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            _this.alignments = [{
                ...
                icon: __WEBPACK_IMPORTED_MODULE_3__assets_garbage_svg___default.a,
                apply: function apply() {
                    window.Quill.find(_this.img).deleteAt(0);
                },
                isApplied: function isApplied() {
                    return window.Quill.find(_this.img) == null;
                }
            }, {
                icon: __WEBPACK_IMPORTED_MODULE_4__assets_edit_svg___default.a,
                apply: function apply() {
                    _this.options.changeImage(_this.img, _this.overlay);
                },
                isApplied: function isApplied() {
                    return window.Quill.find(_this.img) == null;
                }
            }, {
                icon: __WEBPACK_IMPORTED_MODULE_5__assets_link_symbol_svg___default.a,
                apply: function apply() {
                    var link = window.prompt();
                    var blot = Parchment.find(_this.img);
                    _this.options.changeLink(link, blot);
                },
                isApplied: function isApplied() {
                    return window.Quill.find(_this.img) == null;
                }
